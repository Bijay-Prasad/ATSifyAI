      ...
      <Card className="mx-auto w-full max-w-2xl">
        <CardHeader>
          ...
          <CardDescription className="text-pretty">
            Provide a job description and your resume to get an ATS score and tailored suggestions.
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleAnalyze}>
          ...
          <CardFooter className="flex items-center gap-3">
            ...
            <span className="text-xs text-muted-foreground">We’ll never store your documents without consent.</span>
          </CardFooter>
        </form>
      </Card>
    </motion.div>
